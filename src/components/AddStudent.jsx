...
export default function AddStudent() {
    ...
    return (
        <div className='container my-2' style={{maxWidth:'700px'}}>
            ...
            <div className="mb-3">
                <select id="dropdown" className="form-select" defaultValue={newStudent.gender} onChange={(e) => setNewStudent({ ...newStudent, gender: e.target.value })}>
            ...
            <textarea className="form-control mb-3" rows="3" placeholder="Address" value={newStudent.address} onChange={(e) => setNewStudent({ ...newStudent, address: e.target.value })}></textarea>
